  ...
  return (
   ...
   <Router>
     <Routes>
      ...
      <Route path='/contents/DigitalProducts' element={<DigitalProducts/>}/>
      ...
      <Route path='/Website&Apps/SignUpSettings' element={<SignUpSetting/>}/>
      ...
      <Route path='/Reports/DigitalEvaluation' element={<DigitalEvaluation/>}/>
      ...
      <Route path='/Reports/LiveClassLegacy' element={<LiveClassLegacy/>}/>
      <Route path='/Reports/MessangerInsights' element={<MessangerInsights/>}/>
      <Route path='/Reports/PaymentGateways' element={<PaymentGateways/>}/>
      ...
      <Route path='/Manage/CourseEncryption' element={<CourseEncryption/>}/>
      <Route path='/Manage/Discussions' element={<Discussions/>}/>
      <Route path='/Manage/Rating&Reviews' element={<RatingReview/>}/>
      <Route path='/Manage/LegacyAnswerReview' element={<LegacyAnswerReview/>}/>
